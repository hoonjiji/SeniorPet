...
<body>
	<div class="container-fluid" style="padding: 0px">
		...
		<div>
			<form action="updateinfo" method="post" onsubmit="return FormCheck()" class="d-flex flex-column justify-content-around" style="min-height: 90vh;">
				<div class="d-flex flex-column justify-content-around" style="height:20vh;">
				<div class="row">
					<div class="col-1">제목</div>
					<input class="form-control" type="text" name="title" maxlength="30" value="${info.title }" style="width:90%;">
				</div>
				<div class="row">
					<div class="col-1">종류</div>
					<select class="form-select" name="type" style="width:90%;">
	  						<option value="공지" <c:if test="${info.type =='공지' }">selected="selected"</c:if> >공지사항</option>
	  						<option value="정보" <c:if test="${info.type =='정보' }">selected="selected"</c:if>>정보게시판</option>
					</select>
				...
				<div class="row">
					<div class="col">
					<textarea id = "description" name ="content" rows="5" cols="80">${info.content }</textarea>
