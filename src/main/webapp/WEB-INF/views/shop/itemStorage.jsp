...
<div class="d-flex flex-nowrap border border-1" id="wrapper" style="min-height: 90vh;">
	...
	<form action="storage" id="storageForm" method="post" enctype="multipart/form-data">
		<table class="table text-center border">
			<thead>
				<tr>
					<td class="fs-2 fw-bold" colspan="2">상품 입고</td>
				</tr>
			</thead>
			<tr>
				<th>상품명</th>
				<td>
					<input type="text" id="pro_name" name="pro_name" required="required">
				</td>
			</tr>
			<tr>
				<th>상품 정보</th>
				<td>
					<textarea id="pro_info" name="pro_info" rows="5" cols="22" style="resize:none" required="required"></textarea>
				</td>
			</tr>
			<tr>
				<th>상품 이미지</th>
				<td>
					<input type="file" id="pro_image" name="upload" accept="image/*" required="required">
				</td>
			</tr>
			<tr>
				<th>상품 가격</th>
			...
			<tr>
				<td colspan="2" style="text-align: center;"><input type="submit" value="입고"></td>
			</tr>
		</table>
	</form>
	</div>
...
<script>document.getElementById('inputdate').valueAsDate = new Date();</script>
</body>
</html>