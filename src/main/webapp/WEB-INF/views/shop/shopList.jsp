...
<header class="bg-dark py-5">
    <div class="container px-4 px-lg-5 my-5">
        <div class="text-center text-white">
            <h1 class="display-4 fw-bolder">猫の手.ch_Mall</h1>
            <p class="lead fw-normal text-white-50 mb-0">A special choice for Senior Pet</p>
        </div>
    </div>
</header>
...
<!-- Section-->
 ...
 <!-- 페이지 이동 부분 -->
	<div id="navigator" class="mt-auto d-flex justify-content-center">
		<a href="javascript:pagingFormSubmit(${navi.currentPage - navi.pagePerGroup })"><i class="bi bi-chevron-double-left"></i></a>
		<!-- &nbsp;&nbsp; -->
		<a href="javascript:pagingFormSubmit(${navi.currentPage - 1})"><i class="bi bi-chevron-left"></i></a>
		<!-- &nbsp;&nbsp; -->
		<!-- 페이지 수 만큼 반복 -->
		...
		<!-- &nbsp;&nbsp; -->
		<a href="javascript:pagingFormSubmit(${navi.currentPage + 1 })"><i class="bi bi-chevron-right"></i></a>
		<!-- &nbsp;&nbsp; -->
		<a href="javascript:pagingFormSubmit(${navi.currentPage + navi.pagePerGroup })"><i class="bi bi-chevron-double-right"></i></a>
		<!-- <br>&nbsp;&nbsp; -->
		<!-- <a href="/pet">메인으로</a> -->
	</div>
