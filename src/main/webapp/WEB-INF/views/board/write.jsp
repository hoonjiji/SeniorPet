...
<body>
	<div class="container-fluid" style="padding: 0px">
		...
		<div class="container" id="wrapper" style="min-height: 100vh; margin-top: 4vh; margin-bottom:4vh;">
			<div>
			<form action="write" method="post" onsubmit="return FormCheck()" class="d-flex flex-column justify-content-around" style="min-height: 90vh;">
				<div class="d-flex flex-column justify-content-around" style="height:20vh;">
				<div class="row">
				<div class="col-1" style="font-weight: 700">タイトル</div>
				...
				<div class="row">
					...
					<select class="form-select" name="type" style="width:90%">
  						<option value="자유">自由</option>
  						<option value="질문">質問</option>
  						<option value="꿀팁">アドバイス</option>
  						<option value="상품후기">感想</option>
					</select>
				</div>
				</div>
				<div class="row">
